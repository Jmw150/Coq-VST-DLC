...
Definition f_send := {|
  ...
  fn_params := ((_count, tint) :: nil);
  fn_vars := nil;
  fn_temps := ((_n, tint) :: (_t'1, tint) :: nil);
  fn_body :=
(Ssequence
  (Sset _n
    (Ebinop Odiv
      (Ebinop Oadd (Etempvar _count tint) (Econst_int (Int.repr 1) tint)
        tint) (Econst_int (Int.repr 2) tint) tint))
  (Sswitch (Ebinop Omod (Etempvar _count tint) (Econst_int (Int.repr 2) tint)
             tint)
    (LScons (Some 0)
      (Slabel _lol Sskip)
      (LScons (Some 1)
...
((___builtin_ais_annot,
 ...
 (___builtin_debug,
   Gfun(External (EF_external "__builtin_debug"
     ...
     {|cc_vararg:=true; cc_unproto:=false; cc_structret:=false|})) ::
 (_send, Gfun(Internal f_send)) :: (_main, Gfun(Internal f_main)) :: nil).

Definition public_idents : list ident :=
(_main :: _send :: ___builtin_debug :: ___builtin_write32_reversed ::
